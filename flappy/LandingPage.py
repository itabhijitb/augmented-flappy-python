...
class LandingPage:
    def __init__(self, root: tk.Tk) -> None:
        ...
        self.sponsor_school: str = SCHOOL_IMAGE_PATH
    ...
    def process_user_input(self, user_data: Dict[str, Any]) -> None:
        ...
        try:
            ...
            self.update_leaderboard()
def main() -> None:
    excel_file_path: str = "res/leaderboard.xlsx"
    logo_image_path: str = "images/logo.png"
    font_path: str = "res/JurassicPark.otf"

    root: tk.Tk = tk.Tk()
    icon = tk.PhotoImage(file='images/pterodactyl.png')
    root.iconphoto(False, icon)
    app: LandingPage = LandingPage(root)
    root.mainloop()
